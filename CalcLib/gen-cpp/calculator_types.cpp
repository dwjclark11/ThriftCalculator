...
void Work::__set_bNumFirstNumSet(const bool val) {
  this->bNumFirstNumSet = val;
}

void Work::__set_bNumSecondNumSet(const bool val) {
  this->bNumSecondNumSet = val;
}
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->bNumFirstNumSet);
          this->__isset.bNumFirstNumSet = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 5:
        if (ftype == ::apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->bNumSecondNumSet);
          this->__isset.bNumSecondNumSet = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t Work::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("bNumFirstNumSet", ::apache::thrift::protocol::T_BOOL, 4);
  xfer += oprot->writeBool(this->bNumFirstNumSet);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("bNumSecondNumSet", ::apache::thrift::protocol::T_BOOL, 5);
  xfer += oprot->writeBool(this->bNumSecondNumSet);
  xfer += oprot->writeFieldEnd();
...
void swap(Work &a, Work &b) {
  ...
  swap(a.num2, b.num2);
  swap(a.op, b.op);
  swap(a.bNumFirstNumSet, b.bNumFirstNumSet);
  swap(a.bNumSecondNumSet, b.bNumSecondNumSet);
  swap(a.__isset, b.__isset);
}

Work::Work(const Work& other1) noexcept {
  num1 = other1.num1;
  num2 = other1.num2;
  op = other1.op;
  bNumFirstNumSet = other1.bNumFirstNumSet;
  bNumSecondNumSet = other1.bNumSecondNumSet;
  __isset = other1.__isset;
}
Work& Work::operator=(const Work& other2) noexcept {
  num1 = other2.num1;
  num2 = other2.num2;
  op = other2.op;
  bNumFirstNumSet = other2.bNumFirstNumSet;
  bNumSecondNumSet = other2.bNumSecondNumSet;
...
void Work::printTo(std::ostream& out) const {
  ...
  out << ", " << "op=" << to_string(op);
  out << ", " << "bNumFirstNumSet=" << to_string(bNumFirstNumSet);
  out << ", " << "bNumSecondNumSet=" << to_string(bNumSecondNumSet);
  out << ")";
}
...
void InvalidOperation::__set_op(const int32_t val) {
  this->op = val;
}
